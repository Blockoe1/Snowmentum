...
{
    public class PackingMinigameDepreciated : MonoBehaviour
    {
        #region CONST
        ...
        {
            internal abstract IEnumerator Timer(PackingMinigameDepreciated minigameController);
            internal abstract void MouseUpdate(PackingMinigameDepreciated minigameController, Vector2 mouseDelta);

            internal virtual void CleanUp(PackingMinigameDepreciated minigameController) { }
        }
        ...
        private class PackingState : MinigameState
        {
            ...
            internal PackingState(PackingMinigameDepreciated minigameController)
            {
            ...
            internal override void MouseUpdate(PackingMinigameDepreciated minigameController, Vector2 mouseDelta)
            {
            ...
            internal override IEnumerator Timer(PackingMinigameDepreciated minigameController)
            {
            ...
            internal override void CleanUp(PackingMinigameDepreciated minigameController)
            {
                minigameController.minigameAnimator.SetBool(PACKING_ANIM_BOOL, false);
            }
        }
        ...
        private class ThrowState : MinigameState
        {
            ...
            internal ThrowState(PackingMinigameDepreciated minigameController,
